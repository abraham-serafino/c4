...
extern const cstring ITEM_ALLOC_EX;
extern const cstring INVALID_STORE_STATE_EX;
extern const cstring GET_NULL_ITEM_EX;
extern const cstring INVALID_INDEX_EX;
